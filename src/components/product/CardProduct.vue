...
<template>
    <div @click="goToProduct"
        ...
        <!-- Product Image -->
        <img :src="product.images?.length > 0 ? product.images[0] : product.image" :alt="product.name"
        ...
        <div
            ...
            <button @click="toggleFavorite"
                ...
                :class="{ 'text-red-500 bg-red-50!': favoritesStore.isFavorite(product._id || product.id) }">
                <Heart :size="18" :class="{ 'fill-current': favoritesStore.isFavorite(product._id || product.id) }" />
            </button>
