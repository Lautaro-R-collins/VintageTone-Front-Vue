...
const navLinks = [
    ...
    { name: 'Outlet', path: '/category/outlet', color: 'text-amber-500 font-black' }
]
...
<template>
    <div class="flex flex-col lg:flex-row items-center justify-between w-full text-[11px] font-bold uppercase tracking-[0.2em] text-white py-4 lg:py-0 px-6 lg:px-0"
        ref="navbarRef">
        ...
        <div
            class="flex flex-col lg:flex-row items-center gap-2 w-full lg:w-auto border-t border-white/5 lg:border-none mt-2 lg:mt-0 pt-2 lg:pt-0">
