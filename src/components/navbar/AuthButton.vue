...
<template>
  <div class="dropdown dropdown-end cursor-pointer">
    ...
    <ul tabindex="0" class="dropdown-content z-50 menu p-3 shadow-2xl bg-white rounded-xl w-52 mt-4 border border-slate-100 space-y-1">
      ...
      <li>
        <router-link to="/register" class="flex items-center gap-3 py-3 px-4 rounded-xl text-slate-900 font-bold text-xs uppercase tracking-widest hover:bg-amber-500 hover:text-slate-950 transition-all group">
